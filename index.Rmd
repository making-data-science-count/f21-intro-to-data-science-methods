...
author: "Joshua Rosenberg, Ph.D., and Alex Lishinski, Ph.D."
date: "Fall, 2021"
---
...
Note: This class is designed as a fully online and partially synchronous course. We will meet synchronously every week via Zoom on Thursdays 2:50-4:05 pm. This class will be taught in a fully-online format. We will use Zoom for synchronous (or at-the-same-time) a) introductions to new content, b) “try-it-out” laboratories, and c) discussions. We will also use a number of tools for asynchronous communication, especially [Slack (click for link to our class Slack workspace)](https://datascienceinedu.slack.com/).
